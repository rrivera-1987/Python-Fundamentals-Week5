...
def quicksort(the_list, low_idx, high_idx): # Function to let us chec both sides of the pivot. This function will be used recursively.
    if low_idx > high_idx: # For a recursive function, we need to set a base case. A condition in which no recursion will happen.
        return
